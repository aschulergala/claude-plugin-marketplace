...
2. **Success** → "✅ MCP server connected (312 tools available)" — proceed to Step 1
...
> ⚠️ **Restart Claude Code** after setup to activate the MCP server. The 312 tools won't be available until you restart.
